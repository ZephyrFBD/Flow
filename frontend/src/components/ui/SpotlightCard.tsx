    ...
    >
      <div
        style={{
          ...
          inset: 0,
          background: isDark
            ? 'radial-gradient(circle at var(--spotlight-x, 50%) var(--spotlight-y, 50%), rgba(22,119,255,0.15) 0%, transparent 60%)'
            : 'radial-gradient(circle at var(--spotlight-x, 50%) var(--spotlight-y, 50%), rgba(22,119,255,0.06) 0%, transparent 60%)',
          pointerEvents: 'none',
